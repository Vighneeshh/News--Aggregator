...
function App() {
  ...
  const fetchNews = async () => {
    setLoading(true)
    try {
      console.log('Fetching news from http://https://news-aggregator-pppy.onrender.com/news')
      const response = await fetch('http://https://news-aggregator-pppy.onrender.com/news')
  ...
  const fetchHeadlines = async () => {
    setLoading(true)
    try {
      console.log('Fetching headlines from http://https://news-aggregator-pppy.onrender.com/headlines')
      const response = await fetch('http://https://news-aggregator-pppy.onrender.com/headlines')
      const data = await response.json()
  ...
  const getAISummary = async (article) => {
    ...
    try {
      ...
      const response = await fetch('http://https://news-aggregator-pppy.onrender.com/summarize', {
        method: 'POST',
        headers: {
